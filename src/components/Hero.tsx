...
import { ArrowRight, MessageCircle, Activity, Database, Zap, Sparkles } from 'lucide-react';
...
export default function Hero() {
  ...
  const opacityMockup = useTransform(scrollYProgress, [0, 0.8], [1, 0]);
  ...
  return (
    <section ref={containerRef} id="inicio" className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
      {/* Parallax Background Effects */}
      <motion.div 
        style={{ y: yBg1 }}
        className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-cyan-500/10 rounded-full blur-[120px] pointer-events-none" 
      />
      <motion.div 
        style={{ y: yBg2 }}
        className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-600/10 rounded-full blur-[100px] pointer-events-none" 
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <motion.div 
            ...
            className="max-w-2xl"
          >
            <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800/50 border border-slate-700 text-cyan-400 text-sm font-medium mb-6">
            ...
            <motion.p variants={itemVariants} className="text-lg md:text-xl text-slate-400 mb-8 leading-relaxed">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4">
              <a 
                href="#contato" 
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-white text-slate-950 font-semibold hover:bg-cyan-50 transition-colors group"
              >
          ...
          >
            <div className="relative rounded-2xl bg-slate-900/80 border border-slate-800 p-2 shadow-2xl backdrop-blur-sm transform-gpu hover:scale-[1.02] transition-transform duration-500">
              ...
              <div className="p-6 grid gap-4">
                <div className="grid grid-cols-2 gap-4">
                  <motion.div 
                    ...
                    className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50 transition-colors hover:bg-slate-800"
                  >
                ...
                <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50 h-40 flex items-end gap-2 group">
                  {/* Fake Chart Bars */}
                  {[40, 70, 45, 90, 65, 85, 100].map((height, i) => (
                    <motion.div 
                      ...
                      className="flex-1 bg-gradient-to-t from-cyan-500/20 to-cyan-400/80 rounded-t-sm group-hover:from-cyan-400/40 group-hover:to-cyan-300 transition-colors"
                    />
                  ))}
                </div>
            ...
            <motion.div 
              ...
              className="absolute -right-6 -top-6 bg-slate-800 border border-slate-700 rounded-xl p-4 shadow-xl z-20"
            >
              <div className="flex items-center gap-3">
